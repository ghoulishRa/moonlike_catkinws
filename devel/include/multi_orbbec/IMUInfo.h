// Generated by gencpp from file multi_orbbec/IMUInfo.msg
// DO NOT EDIT!


#ifndef MULTI_ORBBEC_MESSAGE_IMUINFO_H
#define MULTI_ORBBEC_MESSAGE_IMUINFO_H
...
struct IMUInfo_
{
  ...
  typedef boost::shared_ptr< ::multi_orbbec::IMUInfo_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::multi_orbbec::IMUInfo_<ContainerAllocator> const> ConstPtr;

}; // struct IMUInfo_

typedef ::multi_orbbec::IMUInfo_<std::allocator<void> > IMUInfo;

typedef boost::shared_ptr< ::multi_orbbec::IMUInfo > IMUInfoPtr;
typedef boost::shared_ptr< ::multi_orbbec::IMUInfo const> IMUInfoConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::multi_orbbec::IMUInfo_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::multi_orbbec::IMUInfo_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::multi_orbbec::IMUInfo_<ContainerAllocator1> & lhs, const ::multi_orbbec::IMUInfo_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsMessage< ::multi_orbbec::IMUInfo_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::multi_orbbec::IMUInfo_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::multi_orbbec::IMUInfo_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::multi_orbbec::IMUInfo_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::multi_orbbec::IMUInfo_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::multi_orbbec::IMUInfo_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::multi_orbbec::IMUInfo_<ContainerAllocator> >
{
  ...
  static const char* value(const ::multi_orbbec::IMUInfo_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xefdf590a2d0b51a4ULL;
  static const uint64_t static_value2 = 0x71d0de8470a87a58ULL;
};

template<class ContainerAllocator>
struct DataType< ::multi_orbbec::IMUInfo_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::multi_orbbec::IMUInfo_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::multi_orbbec::IMUInfo_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::multi_orbbec::IMUInfo_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::multi_orbbec::IMUInfo_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
...
#endif // MULTI_ORBBEC_MESSAGE_IMUINFO_H
