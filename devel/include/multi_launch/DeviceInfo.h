// Generated by gencpp from file multi_launch/DeviceInfo.msg
// DO NOT EDIT!


#ifndef MULTI_LAUNCH_MESSAGE_DEVICEINFO_H
#define MULTI_LAUNCH_MESSAGE_DEVICEINFO_H
...
struct DeviceInfo_
{
  ...
  typedef boost::shared_ptr< ::multi_launch::DeviceInfo_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::multi_launch::DeviceInfo_<ContainerAllocator> const> ConstPtr;

}; // struct DeviceInfo_

typedef ::multi_launch::DeviceInfo_<std::allocator<void> > DeviceInfo;

typedef boost::shared_ptr< ::multi_launch::DeviceInfo > DeviceInfoPtr;
typedef boost::shared_ptr< ::multi_launch::DeviceInfo const> DeviceInfoConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::multi_launch::DeviceInfo_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::multi_launch::DeviceInfo_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::multi_launch::DeviceInfo_<ContainerAllocator1> & lhs, const ::multi_launch::DeviceInfo_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsMessage< ::multi_launch::DeviceInfo_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::multi_launch::DeviceInfo_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::multi_launch::DeviceInfo_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::multi_launch::DeviceInfo_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::multi_launch::DeviceInfo_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::multi_launch::DeviceInfo_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::multi_launch::DeviceInfo_<ContainerAllocator> >
{
  ...
  static const char* value(const ::multi_launch::DeviceInfo_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x1888569b0132dc80ULL;
  static const uint64_t static_value2 = 0x4ac1aacd640af6e8ULL;
};

template<class ContainerAllocator>
struct DataType< ::multi_launch::DeviceInfo_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::multi_launch::DeviceInfo_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::multi_launch::DeviceInfo_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::multi_launch::DeviceInfo_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::multi_launch::DeviceInfo_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
...
#endif // MULTI_LAUNCH_MESSAGE_DEVICEINFO_H
