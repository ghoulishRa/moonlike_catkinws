...
"""autogenerated by genpy from multi_launch/Extrinsics.msg. Do not edit."""
import codecs
import sys
...
"""
  ...
  _slot_types = ['std_msgs/Header','float64[9]','float64[3]']
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(_get_struct_9d().pack(*self.rotation))
      buff.write(_get_struct_3d().pack(*self.translation))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.rotation = _get_struct_9d().unpack(str[start:end])
      start = end
      end += 24
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      self.rotation = numpy.frombuffer(str[start:end], dtype=numpy.float64, count=9)
      start = end
      end += 24
