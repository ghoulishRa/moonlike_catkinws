...
"""autogenerated by genpy from multi_launch/GetCameraInfoRequest.msg. Do not edit."""
import codecs
import sys
...
class GetCameraInfoRequest(genpy.Message):
  ...
  _type = "multi_launch/GetCameraInfoRequest"
...
def _get_struct_I():
    ...
    return _struct_I
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from multi_launch/GetCameraInfoResponse.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
...
class GetCameraInfoResponse(genpy.Message):
  _md5sum = "aacf7dfed1a501be45f34981291a5579"
  _type = "multi_launch/GetCameraInfoResponse"
  _has_header = False  # flag to mark the presence of a Header object
...
"""
  ...
  _slot_types = ['sensor_msgs/CameraInfo','bool','string']
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_6I2B().pack(_x.info.binning_x, _x.info.binning_y, _x.info.roi.x_offset, _x.info.roi.y_offset, _x.info.roi.height, _x.info.roi.width, _x.info.roi.do_rectify, _x.success))
      _x = self.message
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.info.binning_x, _x.info.binning_y, _x.info.roi.x_offset, _x.info.roi.y_offset, _x.info.roi.height, _x.info.roi.width, _x.info.roi.do_rectify, _x.success,) = _get_struct_6I2B().unpack(str[start:end])
...
def _get_struct_3I():
    ...
    return _struct_3I
_struct_6I2B = None
def _get_struct_6I2B():
    global _struct_6I2B
    if _struct_6I2B is None:
        _struct_6I2B = struct.Struct("<6I2B")
    return _struct_6I2B
_struct_9d = None
def _get_struct_9d():
    global _struct_9d
...
class GetCameraInfo(object):
  _type          = 'multi_launch/GetCameraInfo'
  _md5sum = 'aacf7dfed1a501be45f34981291a5579'
