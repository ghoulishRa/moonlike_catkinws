...
"""autogenerated by genpy from multi_orbbec/DeviceInfo.msg. Do not edit."""
import codecs
import sys
...
class DeviceInfo(genpy.Message):
  _md5sum = "1888569b0132dc804ac1aacd640af6e8"
  _type = "multi_orbbec/DeviceInfo"
...
string frame_id
"""
  __slots__ = ['header','name','serial_number','firmware_version','supported_min_sdk_version','hardware_version']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,name,serial_number,firmware_version,supported_min_sdk_version,hardware_version
