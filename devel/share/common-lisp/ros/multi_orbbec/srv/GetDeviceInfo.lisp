...
(cl:in-package multi_orbbec-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <GetDeviceInfo-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetDeviceInfo-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name multi_orbbec-srv:<GetDeviceInfo-request> is deprecated: use multi_orbbec-srv:GetDeviceInfo-request instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<GetDeviceInfo-request>)))
  ...
  "multi_orbbec/GetDeviceInfoRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GetDeviceInfo-request)))
  "Returns string type for a service object of type 'GetDeviceInfo-request"
  "multi_orbbec/GetDeviceInfoRequest")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<GetDeviceInfo-request>)))
  ...
  "a172c842ade7825e92d115b1aef6b0d1")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'GetDeviceInfo-request)))
  "Returns md5sum for a message object of type 'GetDeviceInfo-request"
  "a172c842ade7825e92d115b1aef6b0d1")
...
(cl:defclass <GetDeviceInfo-response> (roslisp-msg-protocol:ros-message)
  ((info
    :reader info
    :initarg :info
    :type multi_orbbec-msg:DeviceInfo
    :initform (cl:make-instance 'multi_orbbec-msg:DeviceInfo))
   (success
    :reader success
    :initarg :success
    :type cl:boolean
...
(cl:defmethod cl:initialize-instance :after ((m <GetDeviceInfo-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetDeviceInfo-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name multi_orbbec-srv:<GetDeviceInfo-response> is deprecated: use multi_orbbec-srv:GetDeviceInfo-response instead.")))

(cl:ensure-generic-function 'info-val :lambda-list '(m))
(cl:defmethod info-val ((m <GetDeviceInfo-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader multi_orbbec-srv:info-val is deprecated.  Use multi_orbbec-srv:info instead.")
  (info m))

(cl:ensure-generic-function 'success-val :lambda-list '(m))
(cl:defmethod success-val ((m <GetDeviceInfo-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader multi_orbbec-srv:success-val is deprecated.  Use multi_orbbec-srv:success instead.")
  (success m))

(cl:ensure-generic-function 'message-val :lambda-list '(m))
(cl:defmethod message-val ((m <GetDeviceInfo-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader multi_orbbec-srv:message-val is deprecated.  Use multi_orbbec-srv:message instead.")
  (message m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<GetDeviceInfo-response>)))
  ...
  "multi_orbbec/GetDeviceInfoResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GetDeviceInfo-response)))
  "Returns string type for a service object of type 'GetDeviceInfo-response"
  "multi_orbbec/GetDeviceInfoResponse")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<GetDeviceInfo-response>)))
  ...
  (cl:format cl:nil "DeviceInfo info~%bool success~%string message~%~%~%================================================================================~%MSG: multi_orbbec/DeviceInfo~%std_msgs/Header header~%string name~%string serial_number~%string firmware_version~%string supported_min_sdk_version~%string hardware_version~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'GetDeviceInfo-response)))
  "Returns full string definition for message of type 'GetDeviceInfo-response"
  (cl:format cl:nil "DeviceInfo info~%bool success~%string message~%~%~%================================================================================~%MSG: multi_orbbec/DeviceInfo~%std_msgs/Header header~%string name~%string serial_number~%string firmware_version~%string supported_min_sdk_version~%string hardware_version~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
