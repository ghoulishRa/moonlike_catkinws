...
(cl:defmethod cl:initialize-instance :after ((m <SetString-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetString-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name multi_orbbec-srv:<SetString-request> is deprecated: use multi_orbbec-srv:SetString-request instead.")))

(cl:ensure-generic-function 'data-val :lambda-list '(m))
(cl:defmethod data-val ((m <SetString-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader multi_orbbec-srv:data-val is deprecated.  Use multi_orbbec-srv:data instead.")
  (data m))
...
(cl:defmethod cl:initialize-instance :after ((m <SetString-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetString-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name multi_orbbec-srv:<SetString-response> is deprecated: use multi_orbbec-srv:SetString-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SetString-response>)))
  ...
  "multi_orbbec/SetStringResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetString-response)))
  "Returns string type for a service object of type 'SetString-response"
  "multi_orbbec/SetStringResponse")
