...
(cl:in-package multi_orbbec-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <DeviceInfo>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'DeviceInfo)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name multi_orbbec-msg:<DeviceInfo> is deprecated: use multi_orbbec-msg:DeviceInfo instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <DeviceInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader multi_orbbec-msg:header-val is deprecated.  Use multi_orbbec-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'name-val :lambda-list '(m))
(cl:defmethod name-val ((m <DeviceInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader multi_orbbec-msg:name-val is deprecated.  Use multi_orbbec-msg:name instead.")
  (name m))

(cl:ensure-generic-function 'serial_number-val :lambda-list '(m))
(cl:defmethod serial_number-val ((m <DeviceInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader multi_orbbec-msg:serial_number-val is deprecated.  Use multi_orbbec-msg:serial_number instead.")
  (serial_number m))

(cl:ensure-generic-function 'firmware_version-val :lambda-list '(m))
(cl:defmethod firmware_version-val ((m <DeviceInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader multi_orbbec-msg:firmware_version-val is deprecated.  Use multi_orbbec-msg:firmware_version instead.")
  (firmware_version m))
...
(cl:defmethod supported_min_sdk_version-val ((m <DeviceInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader multi_orbbec-msg:supported_min_sdk_version-val is deprecated.  Use multi_orbbec-msg:supported_min_sdk_version instead.")
...
(cl:defmethod hardware_version-val ((m <DeviceInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader multi_orbbec-msg:hardware_version-val is deprecated.  Use multi_orbbec-msg:hardware_version instead.")
  (hardware_version m))
