...
(cl:defmethod cl:initialize-instance :after ((m <Metadata>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Metadata)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name multi_launch-msg:<Metadata> is deprecated: use multi_launch-msg:Metadata instead.")))
...
(cl:defmethod json_data-val ((m <Metadata>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader multi_launch-msg:json_data-val is deprecated.  Use multi_launch-msg:json_data instead.")
  (json_data m))
