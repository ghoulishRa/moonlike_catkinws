...
(cl:in-package multi_launch-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <DeviceInfo>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'DeviceInfo)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name multi_launch-msg:<DeviceInfo> is deprecated: use multi_launch-msg:DeviceInfo instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <DeviceInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader multi_launch-msg:header-val is deprecated.  Use multi_launch-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'name-val :lambda-list '(m))
(cl:defmethod name-val ((m <DeviceInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader multi_launch-msg:name-val is deprecated.  Use multi_launch-msg:name instead.")
  (name m))

(cl:ensure-generic-function 'serial_number-val :lambda-list '(m))
(cl:defmethod serial_number-val ((m <DeviceInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader multi_launch-msg:serial_number-val is deprecated.  Use multi_launch-msg:serial_number instead.")
  (serial_number m))

(cl:ensure-generic-function 'firmware_version-val :lambda-list '(m))
(cl:defmethod firmware_version-val ((m <DeviceInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader multi_launch-msg:firmware_version-val is deprecated.  Use multi_launch-msg:firmware_version instead.")
  (firmware_version m))
...
(cl:defmethod supported_min_sdk_version-val ((m <DeviceInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader multi_launch-msg:supported_min_sdk_version-val is deprecated.  Use multi_launch-msg:supported_min_sdk_version instead.")
...
(cl:defmethod hardware_version-val ((m <DeviceInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader multi_launch-msg:hardware_version-val is deprecated.  Use multi_launch-msg:hardware_version instead.")
  (hardware_version m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<DeviceInfo>)))
  ...
  (cl:format cl:nil "std_msgs/Header header~%string name~%string serial_number~%string firmware_version~%string supported_min_sdk_version~%string hardware_version~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'DeviceInfo)))
  "Returns full string definition for message of type 'DeviceInfo"
  (cl:format cl:nil "std_msgs/Header header~%string name~%string serial_number~%string firmware_version~%string supported_min_sdk_version~%string hardware_version~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
