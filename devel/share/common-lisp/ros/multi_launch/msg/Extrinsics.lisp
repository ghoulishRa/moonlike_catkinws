...
(cl:defmethod cl:initialize-instance :after ((m <Extrinsics>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Extrinsics)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name multi_launch-msg:<Extrinsics> is deprecated: use multi_launch-msg:Extrinsics instead.")))
...
(cl:defmethod rotation-val ((m <Extrinsics>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader multi_launch-msg:rotation-val is deprecated.  Use multi_launch-msg:rotation instead.")
  (rotation m))

(cl:ensure-generic-function 'translation-val :lambda-list '(m))
(cl:defmethod translation-val ((m <Extrinsics>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader multi_launch-msg:translation-val is deprecated.  Use multi_launch-msg:translation instead.")
  (translation m))
