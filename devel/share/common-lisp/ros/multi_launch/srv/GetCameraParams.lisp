...
(cl:defmethod cl:initialize-instance :after ((m <GetCameraParams-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetCameraParams-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name multi_launch-srv:<GetCameraParams-request> is deprecated: use multi_launch-srv:GetCameraParams-request instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<GetCameraParams-request>)))
  ...
  "multi_launch/GetCameraParamsRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GetCameraParams-request)))
  "Returns string type for a service object of type 'GetCameraParams-request"
  "multi_launch/GetCameraParamsRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <GetCameraParams-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetCameraParams-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name multi_launch-srv:<GetCameraParams-response> is deprecated: use multi_launch-srv:GetCameraParams-response instead.")))

(cl:ensure-generic-function 'l_intr_p-val :lambda-list '(m))
(cl:defmethod l_intr_p-val ((m <GetCameraParams-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader multi_launch-srv:l_intr_p-val is deprecated.  Use multi_launch-srv:l_intr_p instead.")
  (l_intr_p m))

(cl:ensure-generic-function 'r_intr_p-val :lambda-list '(m))
(cl:defmethod r_intr_p-val ((m <GetCameraParams-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader multi_launch-srv:r_intr_p-val is deprecated.  Use multi_launch-srv:r_intr_p instead.")
  (r_intr_p m))

(cl:ensure-generic-function 'r2l_r-val :lambda-list '(m))
(cl:defmethod r2l_r-val ((m <GetCameraParams-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader multi_launch-srv:r2l_r-val is deprecated.  Use multi_launch-srv:r2l_r instead.")
  (r2l_r m))

(cl:ensure-generic-function 'r2l_t-val :lambda-list '(m))
(cl:defmethod r2l_t-val ((m <GetCameraParams-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader multi_launch-srv:r2l_t-val is deprecated.  Use multi_launch-srv:r2l_t instead.")
  (r2l_t m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<GetCameraParams-response>)))
  ...
  "multi_launch/GetCameraParamsResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GetCameraParams-response)))
  "Returns string type for a service object of type 'GetCameraParams-response"
  "multi_launch/GetCameraParamsResponse")
