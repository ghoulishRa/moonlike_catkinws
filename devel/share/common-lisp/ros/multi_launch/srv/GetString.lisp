...
(cl:defmethod cl:initialize-instance :after ((m <GetString-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetString-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name multi_launch-srv:<GetString-request> is deprecated: use multi_launch-srv:GetString-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <GetString-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetString-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name multi_launch-srv:<GetString-response> is deprecated: use multi_launch-srv:GetString-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<GetString-response>)))
  ...
  "multi_launch/GetStringResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GetString-response)))
  "Returns string type for a service object of type 'GetString-response"
  "multi_launch/GetStringResponse")
