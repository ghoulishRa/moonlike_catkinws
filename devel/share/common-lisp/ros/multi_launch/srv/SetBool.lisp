...
(cl:defmethod cl:initialize-instance :after ((m <SetBool-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetBool-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name multi_launch-srv:<SetBool-request> is deprecated: use multi_launch-srv:SetBool-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <SetBool-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetBool-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name multi_launch-srv:<SetBool-response> is deprecated: use multi_launch-srv:SetBool-response instead.")))
