...
if("TRUE" STREQUAL "TRUE")
  set(orbbec_camera_SOURCE_PREFIX /root/catkin_ws/src/multi_orbbec)
...
if(NOT "/root/catkin_ws/devel/include;/root/catkin_ws/src/multi_orbbec/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'orbbec_camera' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/root/catkin_ws/src/multi_orbbec/${idir}'.  ${_report}")
    endif()
