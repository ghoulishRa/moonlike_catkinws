...
if("TRUE" STREQUAL "TRUE")
  set(spinnaker_camera_driver_SOURCE_PREFIX /root/catkin_ws/src/multi_launch)
...
if(NOT "/root/catkin_ws/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'spinnaker_camera_driver' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/root/catkin_ws/src/multi_launch/${idir}'.  ${_report}")
    endif()
