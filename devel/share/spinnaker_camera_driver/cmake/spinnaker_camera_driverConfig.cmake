...
if("TRUE" STREQUAL "TRUE")
  set(spinnaker_camera_driver_SOURCE_PREFIX /root/catkin_ws/src/flir_camera_driver/spinnaker_camera_driver)
  set(spinnaker_camera_driver_DEVEL_PREFIX /root/catkin_ws/devel)
  ...
  set(spinnaker_camera_driver_INSTALL_PREFIX /root/catkin_ws/install)
...
if(NOT "/root/catkin_ws/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'spinnaker_camera_driver' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/root/catkin_ws/src/flir_camera_driver/spinnaker_camera_driver/${idir}'.  ${_report}")
    endif()
