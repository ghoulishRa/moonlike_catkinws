...
class GetDeviceInfoRequest {
  ...
  static datatype() {
    ...
    return 'multi_orbbec/GetDeviceInfoRequest';
  }
...
class GetDeviceInfoResponse {
  ...
  static datatype() {
    // Returns string type for a service object
    return 'multi_orbbec/GetDeviceInfoResponse';
  }
...
module.exports = {
  ...
  md5sum() { return 'a172c842ade7825e92d115b1aef6b0d1'; },
  datatype() { return 'multi_orbbec/GetDeviceInfo'; }
};
